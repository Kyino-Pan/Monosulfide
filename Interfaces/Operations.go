...
type Operation interface {
	...
	Propose(vars ...*[]byte)
	// When Propose is called, the proposal is sent to the buffer instead of proposing immediately.
