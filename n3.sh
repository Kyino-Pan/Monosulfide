...
go run mainTester.go -k a -p a > output11.txt 2>&1 &
go run mainTester.go -k a -p a > output12.txt 2>&1 &
go run mainTester.go -k a -p a > output13.txt 2>&1 &
go run mainTester.go -k a -p a > output14.txt 2>&1 &
go run mainTester.go -k a -p a > output15.txt 2>&1 &
go run mainTester.go -k a -p a > output16.txt 2>&1 &
