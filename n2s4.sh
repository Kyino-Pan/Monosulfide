...
go run mainTester.go -k a -p a > output1.txt 2>&1 &
go run mainTester.go -k a -p a > output2.txt 2>&1 &
go run mainTester.go -k a -p a > output3.txt 2>&1 &
go run mainTester.go -k a -p a > output4.txt 2>&1 &
go run mainTester.go -k a -p a > output5.txt 2>&1 &
go run mainTester.go -k a -p a > output6.txt 2>&1 &
